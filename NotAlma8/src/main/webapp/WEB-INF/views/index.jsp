...
<!DOCTYPE html>
	...
	<div style="position: fixed;width: 100%; height: 100vh; background-color: #555555 ; z-index: 4"  ></div>
	<div style="position: fixed; vertical-align: middle; z-index: 5"  align="center">
		<table>
		 	<tr><td> <input type="text" placeholder="Baslik"/> </td></tr>
		    <tr><td> <textarea style="height: 400px"></textarea> </td></tr>
		</table>
	...
	<div id="fh5co-offcanvas">
		...
		<div class="fh5co-bio">
			...
			<p>Bilgisayar Muhendisiyim. Web ve Mobil uygulama gelistirmekteyim.</p>
	...
	<header id="fh5co-header">
		...
		<div class="container-fluid">
			...
			<div class="row">
				...
				<ul class="fh5co-social">
					<li><a href="#"><i class="icon-note"></i>Note Ekle</a></li>
					
				</ul>
				<div class="col-lg-12 col-md-12 text-center">
					<h1 id="fh5co-logo"><a href="index.html">BLOGUM</a></h1>
				</div>
	...
	<div class="container-fluid">
		<div class="row fh5co-post-entry"> 
			<article class="col-lg-3 col-md-3 col-sm-3 col-xs-6 col-xxs-12 animate-box">
				...
				<h2 class="fh5co-article-title"><a href="single.html">Blog Basligi</a></h2> 
